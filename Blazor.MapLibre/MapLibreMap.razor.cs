...
using Blazor.MapLibre.Events;
using Blazor.MapLibre.Models;

namespace Blazor.MapLibre
{
    public partial class MapLibreMap : ComponentBase, IAsyncDisposable
    {
        public enum Events
        {
            /// <summary>
        ...
        private DotNetObjectReference<MapLibreMap> _DotNetObjectReference;
        ...
        /// </summary>
        private readonly string _Id = "maplibre_" + Guid.NewGuid();
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            if (firstRender)
            {
                await JsRuntime.InvokeAsync<IJSObjectReference>("import", "/_content/BlazorMapLibre/maplibre-4.5.0/maplibre-gl.js");

                _Module = await JsRuntime.InvokeAsync<IJSObjectReference>("import", "/_content/BlazorMapLibre/MapLibreMap.razor.js");

                await _Module.InvokeVoidAsync("AddStylesheet", "/_content/BlazorMapLibre/maplibre-4.5.0");
        ...
        private ValueTask Create()
        {
            ...
            return _Module.InvokeVoidAsync("MapLibre.create", Options, _DotNetObjectReference);
        }
        ...
        public async Task<Listener> AddListener<T>(Events eventName, string layer, Action<T> handler)
        {
            ...
            {
                await _Module.InvokeVoidAsync("MapLibre.on", _Id, eventName.ToString(), reference);
            }
            else
            {
                await _Module.InvokeVoidAsync("MapLibre.on", _Id, eventName.ToString(), reference, layer);
            }            
        ...
        public async Task<Popup> GetPopup(PopupOptions options)
        {
            ...
            await _Module.InvokeVoidAsync($"MapLibrePopup.create", popup.ContainerId, options);
            return popup;
        }
        ...
        public ValueTask AddLayer(Layer layer, string beforeId = null) => _Module.InvokeVoidAsync("MapLibre.addLayer", _Id, layer, beforeId);
        ...
        public ValueTask AddSource(string id, Source source) => _Module.InvokeVoidAsync("MapLibre.addSource", _Id, id, source);
        ...
        public ValueTask FitBounds(LngLatBounds bounds) => _Module.InvokeVoidAsync($"MapLibre.fitBounds", _Id, bounds);

        /// <summary>
        /// Returns the map's geographical centerpoint.
        /// </summary>
        /// <returns><see cref="LngLat">LngLat</see>: The map's geographical centerpoint.</returns>
        public ValueTask<LngLat> GetCenter() => _Module.InvokeAsync<LngLat>($"MapLibre.getCenter", _Id);
        ...
        public ValueTask<Point> Project(LngLat coordinate) => _Module.InvokeAsync<Point>("MapLibre.project", _Id, coordinate);
        ...
        /// </summary>
        public ValueTask Resize() => _Module.InvokeVoidAsync($"MapLibre.resize", _Id);
        ...
        public ValueTask SetFeatureState(Feature feature, Dictionary<string, object> state) => _Module.InvokeVoidAsync("MapLibre.setFeatureState", _Id, feature, state);
